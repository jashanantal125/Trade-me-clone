        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl">
              Connecting businesses worldwide with skilled workers, and helping candidates find 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Supporting both employers and job seekers worldwide"
            center
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                We help businesses worldwide find qualified candidates for their workforce needs. 
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Recruitment across diverse sectors worldwide"
            center
          />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold mb-6 text-center text-gray-900">Global Work Culture</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Modern workplaces worldwide are known for their collaborative, inclusive, and balanced approach. 
                ...
                <p>
                  For migrants, understanding global work culture and compliance requirements is 
